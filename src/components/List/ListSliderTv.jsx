...
const ListSliderTvshows = ({items, title, row}) => {
    ...
    <div className="ptrack-container">
      <div className="rowContent slider-hover-trigger-layer" >
        <div className="slider">
          {
            handlePrev ?  <span className="handle handlePrev active" onClick={handleLeft} role="button" aria-label="Voir les titres précédents">
          ...
          <span className="handle handleNext active" onClick={handleRight} role="button" aria-label="Voir plus de titres">
...
export default ListSliderTvshows;